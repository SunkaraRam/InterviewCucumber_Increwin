...
public class ExtentTestListeners{
...
//		}
	...
	public static void main(String[] args) {
		...
		String date = ExtentTestListeners.getcurrentdateandtime();
	 ...
	 * report = new ExtentHtmlReporter(reportLocation);
	 * report.config().setDocumentTitle("Automation Test Report");
	 * report.config().setReportName("RamSunkara QA");
	 * report.config().setTheme(Theme.STANDARD);
	 * System.out.println("Extent Report location initialized"); report.start();
	 * 
	 * extent = new ExtentReports(); extent.attachReporter(report);
	 * extent.setSystemInfo("Application", "PrimusBank");
	 * extent.setSystemInfo("Operating System", System.getProperty("os.name"));
	 * extent.setSystemInfo("User Name", System.getProperty("user.name"));
